      ...
      <footer>
        ...
        <div className="container links ">
          ...
          <ul className="contact-links flex">
            ...
            <li>
              <a href="https://example.com">Mail</a>
            </li>
          </ul>
        </div>
        <div className="website-information">
          <div className="tech-info">
            <p>
              ...
              Recreated the website <a href="https://oh.studio/">OH.STUDIO</a>{" "}
              to improve my frontend skills. Images and videos are taken from{" "}
              <a href="https://www.pexels.com/">Pexels</a>. Whereas, icons and
              svgs are from <a href="https://fontawesome.com/">Font Awesome</a>.
              Moreover, videos are cropped using{" "}
              <a href="https://www.onlineconverter.com/">Online Converter</a>.
            </p>
          </div>
          <div className="tech">
